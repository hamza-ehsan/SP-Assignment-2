...
def main():
	...
	print("{0} Getting list of qari...".format(datetime.now()))
	f.write("{0} Getting list of qari...\n".format(datetime.now()))
	qari_list = get_all_links(URL)
	print("{1} Number of qaris: {0}".format(len(qari_list), datetime.now()))
	f.write("{1} Number of qaris: {0}\n".format(len(qari_list), datetime.now()))
	print("......................")
	f.write("......................\n")
	
	for qari in qari_list:
		i+=1
		print('{2} Processing qari no. {0}, qari: {1}'.format(i,qari[:-1], datetime.now()))
		f.write('{2} Processing qari no. {0}, qari: {1}\n'.format(i,qari[:-1], datetime.now()))
